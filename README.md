...
- ✅ Start serving at `http://10.10.10.35:5100`
...
Frontend available at: `http://10.10.10.35:5173`
...
Frontend automatically connects to `http://10.10.10.35:5100/api`
...
|---------|-----|-------------|
| Frontend | http://10.10.10.35:5173 | React UI |
| Backend API | http://10.10.10.35:5100 | REST API |
| Swagger Docs | http://10.10.10.35:5100/swagger | Interactive API documentation |
...
```
Solution: Ensure backend is running on http://10.10.10.35:5100
...
1. **Check Backend Health:**
   - Visit http://10.10.10.35:5100/swagger
   - Try the `/api/Branch/` GET endpoint
   - Should return list of branches

2. **Check Frontend:**
   - Visit http://10.10.10.35:5173
...
- **[API Documentation](http://10.10.10.35:5100/swagger)** - Interactive API docs (when running)
