...
const ImmunizationPage = () => {
  ...
  const showingFrom = filteredRecords.length === 0 ? 0 : startIndex + 1;
  const showingTo = Math.min(startIndex + entriesPerPage, filteredRecords.length);
      ...
      <div className="space-y-3">
        <section className="rounded-md border border-slate-200 bg-white shadow-sm">
          ...
          <div className="flex flex-col gap-3 px-6 py-4 text-sm text-slate-600 md:flex-row md:items-center md:justify-between">
            <div>Showing {showingFrom} to {showingTo} of {filteredRecords.length} entries</div>
            <div className="flex items-center gap-2">
