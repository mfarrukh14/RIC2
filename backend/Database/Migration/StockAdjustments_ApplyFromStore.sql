...
SELECT 'Inv.StockAdjustments (store-derived)', Id, BranchId FROM Inv.StockAdjustments;

UPDATE s
SET s.BranchId = ps.BranchId
FROM Inv.StockAdjustments s
...
SELECT BranchId, COUNT(*) FROM Inv.StockAdjustments GROUP BY BranchId;
