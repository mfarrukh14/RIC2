...
namespace InventoryManagement.Api.Services
{
    public class StockConsumptionService : IStockConsumptionService
    {
        ...
        public async Task<PagedResult<StockConsumptionView>> GetAllAsync(StockConsumptionSearchRequest? request, bool isAdmin, IReadOnlyCollection<int> allowedStoreIds)
        {
